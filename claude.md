...
affected. `stock_bot/main.py` only, no strategy files, hash unchanged.
...
Run: `python -m pytest --tb=short -q` — must show **841 passed**. (This line had drifted to a
