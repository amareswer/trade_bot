...
from this change; the header total and `--collect-only` agree at 770, the individual rows lag.)
...
Run: `python -m pytest --tb=short -q` — must show **770 passed**. (This line had drifted to a
