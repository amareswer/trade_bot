...
from bot.indicators.indicators import rsi as calc_rsi, trend as calc_trend, ema as calc_ema
...
class IndicatorStrategy:
    ...
    def __init__(self, config: IndicatorConfig | None = None):
        ...
        logger.info(
            ...
            " | EMA(%d/%d) min_spread=%.2f%% | warmup=%d",
    ...
    def evaluate(self, price: float) -> Signal:
        ...
        logger.info(
            "price=%.2f RSI=%.1f(%s) trend=%s EMA_spread=%.3f%% strong=%s",
            price, rsi_val,
