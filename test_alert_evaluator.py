"""
Hermetic tests for AlertEvaluator's EARNINGS_SOON handling.

2026-07-21 incident: an EARNINGS_SOON Telegram alert fired HIGH priority for
T (AT&T) — a watchlist symbol the user does not hold. The message gave no
indication that (a) nothing was owned and (b) new entries were already
